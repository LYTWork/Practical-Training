...
public class ReturnList {
	...
	@Transient
	private List<ReturnListDrugs> returnListDrugsList=null; // 退货单药品集合

//	public  ReturnList(Integer id,float amountPaid,float amountPayable,String remarks,Date customerReturnDate,String customerReturnNumber,Integer state,Integer supplierId,Integer userId){
//		this.id = id;
//		this.amountPaid = amountPaid;
//		this.amountPayable = amountPayable;
//		this.remarks = remarks;
//		this.returnDate = customerReturnDate;
//		this.returnNumber = customerReturnNumber;
//		this.state = state;
...
//	}
	...
	public List<ReturnListDrugs> getReturnListDrugsList() {
		return returnListDrugsList;
	}

	public void setReturnListDrugsList(List<ReturnListDrugs> returnListDrugsList) {
		this.returnListDrugsList = returnListDrugsList;
	}
