...
public class PurchaseList {
	...
	@Transient
	private List<PurchaseListDrugs> purchaseListDrugsList=null; // 采购单药品集合
	...
	public List<PurchaseListDrugs> getPurchaseListDrugsList() {
		return purchaseListDrugsList;
	}

	public void setPurchaseListDrugsList(List<PurchaseListDrugs> purchaseListDrugsList) {
		this.purchaseListDrugsList = purchaseListDrugsList;
	}
