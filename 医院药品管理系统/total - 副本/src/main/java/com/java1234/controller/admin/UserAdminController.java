...
public class UserAdminController {
	...
	protected static final Logger logger = LoggerFactory.getLogger(UserAdminController.class);
	...
	public Map<String,Object> modifyPassword(Integer id,String newPassword,HttpSession session) {
		...
		logger.info(user.getUserName()+"修改密码");
