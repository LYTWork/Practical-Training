...
public class SaleList {
	...
	@Transient
	private List<SaleListDrugs> saleListDrugsList=null; // 销售单药品集合
	...
	public List<SaleListDrugs> getSaleListDrugsList() {
		return saleListDrugsList;
	}

	public void setSaleListDrugsList(List<SaleListDrugs> saleListDrugsList) {
		this.saleListDrugsList = saleListDrugsList;
	}
