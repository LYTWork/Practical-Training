...
public class CustomerReturnList {
	...
	@Transient
	private List<CustomerReturnListDrugs> customerReturnListDrugsList=null; // 客户退货单药品集合

    public  CustomerReturnList(Integer id,float amountPaid,float amountPayable,Date customerReturnDate,String customerReturnNumber,String remarks,Integer state,Integer userId,Integer customerId){
        this.id = id;
	...
	public List<CustomerReturnListDrugs> getCustomerReturnListDrugsList() {
		return customerReturnListDrugsList;
	}

	public void setCustomerReturnListDrugsList(List<CustomerReturnListDrugs> customerReturnListDrugsList) {
		this.customerReturnListDrugsList = customerReturnListDrugsList;
	}
